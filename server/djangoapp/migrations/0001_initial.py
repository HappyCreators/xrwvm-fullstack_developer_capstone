    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100)),
                ('type', models.CharField(choices=[('HATCHBACK', 'Hatchback'), ('SEDAN', 'Sedan'), ('SUV', 'SUV'), ('WAGON', 'Wagon'), ('PICKUP', 'Pickup'), ('OFF-ROADER', 'Off-Roader'), ('VAN', 'Van')], default='SUV', max_length=10)),
